...
extern void       dns_queue(struct dns *,
                            void *context,
                            const char *host,
                            enum dns_query_type type,
                            dns_callback_t callback);
extern void       dns_cancel(struct dns *,
                             const void *context);
extern int        dns_poll(struct dns *);
extern int        resolve(const char *domain,
                          void (*a_callback)(struct dns_cb_data *));
extern int        callback_data_error_code(struct dns_cb_data *cbd); 
extern char       *callback_data_address(struct dns_cb_data *cbd, char *);
extern const char *callback_data_name(struct dns_cb_data *cbd);
